...
class Config:
    ...
    BOT_TOKEN = getenv("BOT_TOKEN", "8557326576:AAG3gbiJXRkaTb5jbDCoHh6C0Eq34AVS4tI")

    # Admin / Owner IDs
    SUDO = list(map(int, getenv(
        "SUDO",
        "7554081592 6932036365 7564050858 5656436152"
    ).split()))
    ...
    # Posts to copy
    POSTS = [
        "https://t.me/forward_hack_lnx/79",
        "https://t.me/forward_hack_lnx/80"
    ]
